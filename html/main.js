...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 26251968,
    DYNAMIC_BASE = 31494848,
    DYNAMICTOP_PTR = 26251040;
...
var ASM_CONSTS = {
  164096: function() {throw 'Canceled!'},  
 164344: function($0, $1) {setTimeout(function() { _do_emscripten_dispatch_to_thread($0, $1); }, 0);}
};
...
// STATICTOP = STATIC_BASE + 26250944;
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=26251952;function _emscripten_futex_wake(addr, count) {
  ...
  function cleanupThread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 26251200;
