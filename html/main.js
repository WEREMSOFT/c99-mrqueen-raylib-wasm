...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 26238096,
    DYNAMIC_BASE = 31480976,
    DYNAMICTOP_PTR = 26237168;
...
var ASM_CONSTS = {
  163664: function() {throw 'Canceled!'},  
 163912: function($0, $1) {setTimeout(function() { _do_emscripten_dispatch_to_thread($0, $1); }, 0);}
};
...
// STATICTOP = STATIC_BASE + 26237072;
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=26238080;function _emscripten_futex_wake(addr, count) {
  ...
  function cleanupThread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 26237328;
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(7, 1, index, gamepadState);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(8, 1);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(9, 1, pointerlockStatus);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(10, 1, target, deferUntilInEventHandler);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(16, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(24, 1, fd, offset_low, offset_high, whence, newOffset);
  try {
