...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 26255296,
    DYNAMIC_BASE = 31498176,
    DYNAMICTOP_PTR = 26254368;
...
var ASM_CONSTS = {
  181056: function() {throw 'Canceled!'},  
 181304: function($0, $1) {setTimeout(function() { _do_emscripten_dispatch_to_thread($0, $1); }, 0);}
};
...
// STATICTOP = STATIC_BASE + 26254272;
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=26255280;function _emscripten_futex_wake(addr, count) {
  ...
  function cleanupThread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 26254528;
