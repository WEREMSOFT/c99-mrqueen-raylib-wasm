...
void game_context_pass_to_state_castling_black_right(game_context_t* game_context){
...
void game_context_pass_to_state_castling_black_left(game_context_t* game_context){
        ...
        switch(event.type){
            ...
            case EVENT_RESPONSE:
            {
                ...
                if(strcmp(event.data, "e8g8") == 0
                    ...
                    game_context_pass_to_state_castling_black_right(game_context);
                    ...
                    game_context_pass_to_state_castling_black_left(game_context);
                } else {
...
void game_context_draw(game_context_t* game_context) {
    ...
    if(game_context->board_dirty){
        game_board_calculate_attacked_positions(game_context);
...
void game_context_update(game_context_t* game_context)
{
    game_context_event_process(game_context);
